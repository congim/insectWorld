...
func TestNewCombat(t *testing.T) {
	...
	c := NewCombat(1, 1, 10, attackerIDs, defenderIDs, 100, 1000)
...
func TestCombat_CheckMaxRounds(t *testing.T) {
	c := NewCombat(1, 1, 3, []int64{101}, []int64{201}, 100, 1000)
...
func TestCombat_IsLongCombat(t *testing.T) {
	c1 := NewCombat(1, 1, 5, []int64{101}, []int64{201}, 100, 1000)
	assert.False(t, c1.IsLongCombat())

	c2 := NewCombat(2, 1, 6, []int64{101}, []int64{201}, 100, 1000)
